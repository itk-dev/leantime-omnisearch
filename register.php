...
Events::add_event_listener(
    ...
    function () {
        if (isset($_SESSION['userdata']['id']) && !is_null($_SESSION['userdata']['id'])) {
            $projectCacheExpiration = app()->make(SettingsService::class)->getSetting("omnisearchsettings.projectscache") ?: '14400';
            $ticketCacheExpiration = app()->make(SettingsService::class)->getSetting("omnisearchsettings.ticketscache") ?: '14400';
